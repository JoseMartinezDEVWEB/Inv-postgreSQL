...
export const up = (db) => {
  ...
  db.exec(`
    CREATE TABLE IF NOT EXISTS usuarios (
      ...
      telefono TEXT,
      rol TEXT CHECK(rol IN ('contable', 'contable', 'colaborador', 'administrador')) NOT NULL DEFAULT 'colaborador',
  ...
  db.exec(`
    CREATE TABLE IF NOT EXISTS sesiones_colaboradores (
      ...
      usuarioId INTEGER NOT NULL,
      rol TEXT CHECK(rol IN ('contable', 'colaborador')) DEFAULT 'colaborador',
